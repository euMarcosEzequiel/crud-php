                        ...
                        do{
                            echo "  
                                <tr>
                                    ...
                                    <td class='table-acao'>
                                        <a class='btn-action btn-alterar' href='alterar.php?id=".$linha[0]."' title='Alterar'><i class='bx bx-transfer-alt'></i></a>
                                        <a class='btn-action btn-excluir' href='excluir.php?id=".$linha[0]."' title='Excluir' onclick='return confirm(\"Deseja excluir esse registro?\")'><i class='bx bx-trash'></i></a>
                                    </td>
                                </tr>
                            ";
